  ...
  return (
    <>
      <div className="w-full bg-[#333] relative">
        <div className="top-layer absolute top-[-8%]">
          <img src="black-border.svg" alt="" />
        </div>

        <div className="relative">
          <img className="boom-layer" src="boom_layer.svg" alt="" />
          <img className="top-layer absolute top-0" src="top_layer.svg" alt="" />
        </div>

        <div className="font-['bebas_neue'] font-bold text-[#ffedd7] leading-[28vmax] text-[30vmax] px-4 py-12">
          <h1>GIVES YOU</h1>
          <h1>WIIINGS !</h1>
        </div>
